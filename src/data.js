...
let attractorRadius = 40;
let constBallRadius = 20;
...
const ballRadius = [15, 30, 20];
const ballMass = 6 * Math.pow(10, 6);
...
let savedConfigurations = [
  {
    attractors: [
      { x: 697, y: 490.5, r: attractorRadius <= 40 ? attractorRadius : 40 }
    ],
    balls: [
      {
        r: constBallRadius <= 20 ? constBallRadius : 20,
